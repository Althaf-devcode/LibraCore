...
<div class="relative w-full max-w-md">
    ...
    <div class="mb-8 flex flex-col items-center text-center">
        ...
        <h1 class="mt-4 text-3xl font-extrabold tracking-tight text-white">LibraCore</h1>
    ...
    <p class="mt-8 text-center text-xs text-blue-300/70">&copy; <?= date('Y') ?> LibraCore &middot; Library Management System</p>
</div>
